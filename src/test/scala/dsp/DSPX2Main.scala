...
/**
  ...
  * }}}
  */
object DSPX2Main extends App {
  iotesters.Driver.execute(args, () => new DSPX2Wrapper) {
...
/**
  ...
  * }}}
  */
object DSPX2Repl extends App {
  iotesters.Driver.executeFirrtlRepl(args, () => new DSPX2Wrapper)
}
